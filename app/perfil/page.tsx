...
export default function page() {
  ...
  const [formChange, setFormChange] = useState<FormChange>({
    name: false,
    lastName: false,
    id: false,
    tel: false,
  ...
  return (
    <div className="bg-white">
      <main className="flex flex-col h-screen px-4 pt-16 mx-auto md:px-12 xl:px-24">
        <div className="px-6 pt-10 mb-6 text-left border-b-2 border-border md:px-0 md:text-left">
          <div className="w-full mb-4 text-center md:flex md:items-end md:justify-between md:text-left">
        ...
        {!userData ? (
          <div className="flex flex-col items-center mb-4">
            <div className="justify-between w-full max-w-6xl text-left md:flex">
              <div className="w-full px-6 mb-6 md:w-2/5 md:px-0">
                <Skeleton className="mb-2 mt-1 h-4 w-[100px] rounded-full" />
          ...
          <div className="flex flex-col items-center mb-4">
            <div className="justify-between w-full max-w-6xl text-left md:flex">
              <div className="flex justify-center w-full px-6 mb-6 md:block md:w-2/5 md:px-0">
                ...
                <div className="flex flex-col w-full max-w-md">
                  ...
                  <div className="flex space-x-2">
                    <Input
                      ...
                      type="text"
                      className="bg-transparent"
                      disabled={!formChange.lastName}
                    />
                    {!formChange.lastName ? (
                      <Button
                        variant="default"
                        onClick={() => handleFormChange("lastName")}
                        disabled={loadingNewData}
                      >
                        Editar
                      </Button>
